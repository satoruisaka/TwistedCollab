...
TwistedCollab Configuration - Unified configuration with environment variable support
"""
...
# Web cache and sessions are json files, others are markdown files
WEB_CACHE_DIR = DATA_DIR / "web_cache"
SESSIONS_DIR = DATA_DIR / "sessions"
SOURCE_NOTES_DIR = DATA_DIR / "markdown" / "notes"
SOURCE_USER_UPLOADS_DIR = DATA_DIR / "markdown" / "user_uploads"
SOURCE_NEWS_ARTICLES_DIR = DATA_DIR / "markdown" / "news_articles"
...
# This is separate from TwistedCollab's embedder. To control Ollama's GPU memory:
...
# Auto-indexing behavior (during TwistedCollab runtime)
...
LOG_FILE = PROJECT_ROOT / "twisted_collab.log"
